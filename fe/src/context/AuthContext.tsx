...
// Dùng tên key khó đoán hơn để giảm rủi ro XSS đọc rõ tên
const TOKEN_KEY = "app.s.t";
const USER_KEY = "app.u";
const REFRESH_KEY = "app.r.t";
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  useEffect(() => {
    // attempt silent refresh once if we have refresh token but no access token
